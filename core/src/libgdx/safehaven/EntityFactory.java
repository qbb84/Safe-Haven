...
public class EntityFactory {
	...
	private EntityFactory() {
		...
		_entities.put(EntityName.TOWN_GUARD_WALKING.toString(),
			Entity.loadEntityConfigByPath(TOWN_GUARD_WALKING_CONFIG));
	...
	public static Entity getEntity(EntityType entityType) {
		...
		switch (entityType) {
			case PLAYER:
				...
				return entity;
			case PLAYER_DEMO:
				entity = new Entity(new NPCInputComponent(), new PlayerPhysicsComponent(),
					new PlayerGraphicsComponent());
				return entity;
			case NPC:
