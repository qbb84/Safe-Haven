...
import libgdx.safehaven.EntityConfig.AnimationConfig;
...
public class PlayerGraphicsComponent extends GraphicsComponent {
	...
	public void update(Entity entity, MapManager mapMgr, Batch batch, float delta) {
        ...
        _shapeRenderer.rect(rect.getX() * Map.UNIT_SCALE , rect.getY() * Map.UNIT_SCALE, rect.getWidth() * Map
        .UNIT_SCALE, rect.getHeight()*Map.UNIT_SCALE);
        _shapeRenderer.end();
        */
	}
