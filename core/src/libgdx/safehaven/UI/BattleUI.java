...
import libgdx.safehaven.battle.BattleState;
	...
	public void onNotify(Entity entity, BattleEvent event) {
		switch (event) {
			...
			case OPPONENT_HIT_DAMAGE:
				int damage =
					Integer.parseInt(entity.getEntityConfig().getPropertyValue(EntityConfig.EntityProperties.ENTITY_HIT_DAMAGE_TOTAL.toString()));
