...
import libgdx.safehaven.UI.StoreInventoryObserver.StoreInventoryEvent;
...
public class StoreInventoryUI extends Window implements InventorySlotObserver, StoreInventorySubject {
		...
		_buyButton.addListener(new ClickListener() {
								   ...
								   public void clicked(InputEvent event, float x, float y) {
									   if (_fullValue > 0 && _playerTotal >= _fullValue) {
										   ...
										   StoreInventoryUI.this.notify(Integer.toString(_playerTotal),
										   ...
										   InventoryUI.setInventoryItemNames(_playerInventorySlotTable,
	...
	public void savePlayerInventory() {
		Array<InventoryItemLocation> playerItemsInPlayerInventory =
			InventoryUI.getInventoryFiltered(_playerInventorySlotTable, InventoryUI.STORE_INVENTORY);
		Array<InventoryItemLocation> playerItemsInStoreInventory =
			InventoryUI.getInventoryFiltered(_playerInventorySlotTable, _inventorySlotTable,
				InventoryUI.STORE_INVENTORY);
		playerItemsInPlayerInventory.addAll(playerItemsInStoreInventory);
		StoreInventoryUI.this.notify(_json.toJson(playerItemsInPlayerInventory),
